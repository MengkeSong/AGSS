...
def test(args, model, image_list):
    ...
    # save_path = r'F:\Sook\datasets\Video8K\1Enhanced datasets\Data Pool\my_datapool\train_masks_num/'
    save_path = r'C:\Users\dell\Desktop\antiuav_save/'
    for idx in tqdm(range(len(image_list))):
        ...
        cv2.imwrite(save_path + name.replace(".jpg", ".png"), sal_map)
        # cv2.imwrite(image_list[idx].replace(".jpg", "_edn.png"), sal_map)


 
def main(args, example_dir):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--example_dir', default=r"C:\Users\dell\Desktop\antiuav/", help='Data directory')
