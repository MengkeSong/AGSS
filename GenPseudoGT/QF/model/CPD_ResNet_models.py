...
class CPD_ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x4_2 = self.resnet.layer4_2(x3_2)  # 2048 x 8 x 8  torch.Size([b, 2048, 7, 7])
        x2_2 = self.rfb2_2(x2_2)#torch.Size([10, 32, 28, 28])
        x3_2 = self.rfb3_2(x3_2)#torch.Size([10, 32, 14, 14])
        x4_2 = self.rfb4_2(x4_2)#torch.Size([10, 32, 7, 7])
