...
from data_2_stream import get_loader,test_dataset
...
parser.add_argument('--batchsize', type=int, default=9, help='training batch size')
...
image_root = r'C:\Users\Administrator\Desktop\CPD-master\sal_map\for_gen_gt\train_last50%\rgb/'
flo_root = r'C:\Users\Administrator\Desktop\CPD-master\sal_map\for_gen_gt\train_last50%\flo/'
gt_root = r'C:\Users\Administrator\Desktop\CPD-master\sal_map\for_gen_gt\train_last50%\\gt/'
...
train_loader,train_size = get_loader(image_root,flo_root, gt_root, batchsize=opt.batchsize, trainsize=opt.trainsize)
...
if opt.is_ResNet:
    save_path = 'traind_models/CPD_Resnet_2_stream_gen_gt/'
else:
...
def train(train_loader, model, optimizer, epoch):
    ...
    if (epoch+1) % 1 == 0:
        torch.save(model.state_dict(), save_path + 'Res_gen_gt_CPD_last50%.pth')
